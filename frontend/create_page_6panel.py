...
def add_text(image_path: str, dialog_text: str) -> int:
    ...
    temp_img = temp_img[295: 1304, 0: 755]
...
#     ["image_1.png", "THE SHADOW STRIKES SILENTLY, UNLEASHING A CASCADE OF CHAOS ON THE UNWARY."],
...
#     ["image_5.png", "A WHISPER OF HOPE ECHOES BRIEFLY THROUGH THE STARLIT NIGHT."],
#     ["image_6.png", "IN THE FINAL MOMENT, DESTINY IS REWRITTEN WITH UNYIELDING COURAGE."]
# ])


add_text("grok.png", "aw hell na")